...
DB_VARS = ('localhost', 'root', 'penguin25', 'crawler_test') # 'localhost' for node w/ the db

NODE_START_DELAY = 0  # in seconds; allows node to receive messages but does not start actual crawl
